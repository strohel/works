# -*- coding: utf-8 -*-
#
# Asim documentation build configuration file, created by
# sphinx-quickstart on Thu Mar  8 19:13:14 2012.
#
...
project = u'Asim'
copyright = u'2012, Václav Šmídl, Radek Hofman, Matěj Laitl'
...
latex_documents = [
    ('index', 'Asim.tex', u'Asim Documentation',
     u'Matěj Laitl', 'manual')  # Václav Šmídl, Radek Hofman, 
]
...
man_pages = [
    ('index', 'asim', u'Asim Documentation',
     [u'Václav Šmídl, Radek Hofman, Matěj Laitl'], 1)
]
...
intersphinx_mapping = {
    ...
    'http://strohel.github.com/PyBayes-doc/': None,
}
